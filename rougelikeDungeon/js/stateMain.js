...
let game,
    ...
    worldWidth,
    display, displayJustify, displayLeading,
    meterWidth, meterHeight, meterX, meterY,
    levelDisplay,
    score, scoreLabel, scoreDisplay,
    lifeMeter, lifeLabel, lifeMeterBG,
    powerLabel, powerMeter, powerMeterBG, currentPower,
    style,
    cursors,
    colorPalette = {
        blue: 0x3366FF,
...
let StateMain = {
    ...
    show: function (things) {
        things.map(thing => {
            game.physics.arcade.overlap(thing, visibleArea, (area, block) => {block.alpha = 1});
        })
    },
