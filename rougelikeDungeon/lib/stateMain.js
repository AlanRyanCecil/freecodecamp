...
let StateTitle = {
    ...
    create: function () {
        ...
        let bullet = '\n\u00B7    ';
        let instructionText = '' + bullet + 'The strength of your attack increases with speed and vitality.' + bullet + 'You can only attack when you have a weapon.' + bullet + 'Weapons are made of gold.';
...
class Main extends React.Component {
    render() {
        return React.createElement('section', null, React.createElement(PhaserContainer, null));
    }
}
